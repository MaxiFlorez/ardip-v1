                        ...
                        @foreach ($brigadas as $brigada)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    @can('super-admin')
                                        <a href="{{ route('admin.brigadas.edit', $brigada) }}" class="text-primary-600 hover:text-primary-900 dark:text-primary-400 dark:hover:text-primary-300">
                                            ✏️ Editar
                                        </a>
                    ...
                    @foreach ($brigadas as $brigada)
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                            ...
                            <div class="flex space-x-2 mt-3">
                                @can('super-admin')
                                    <a href="{{ route('admin.brigadas.edit', $brigada) }}" class="flex-1 bg-primary-600 hover:bg-primary-700 text-white text-center py-2 px-3 rounded text-sm">
                                        ✏️ Editar
                                    </a>
