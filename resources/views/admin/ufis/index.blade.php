<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.ufis.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                ➕ Nueva UFI
            </a>
        </div>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    @if ($ufis->isEmpty())
                        <div class="text-center py-8">
                            ...
                            <a href="{{ route('admin.ufis.create') }}" class="mt-4 inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                ➕ Crear Primera UFI
                            </a>
                        </div>
                    @else
                                    ...
                                    @foreach ($ufis as $ufi)
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                                <a href="{{ route('admin.ufis.edit', $ufi) }}" class="text-indigo-600 hover:text-indigo-900">
                                                    ✏️ Editar
                                                </a>
                            ...
                            @foreach ($ufis as $ufi)
                                <div class="bg-white border rounded-lg p-4 shadow">
                                    ...
                                    <div class="flex space-x-2 mt-3">
                                        <a href="{{ route('admin.ufis.edit', $ufi) }}" class="flex-1 bg-indigo-500 hover:bg-indigo-700 text-white text-center py-2 px-3 rounded text-sm">
                                            ✏️ Editar
                                        </a>
